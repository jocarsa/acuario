...
class Pez:
    def __init__(self):
        ...
        self.acceleration = self.max_speed / 50  # Adjust acceleration rate as needed
    ...
    def mueve(self):
        ...
        target_speed = self.max_speed if (self.is_chasing_food or self.is_avoiding_collision) else self.initial_speed
